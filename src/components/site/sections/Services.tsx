    ...
    <section id="services" className="relative py-32">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-xs uppercase tracking-[0.5em] text-[oklch(0.82_0.14_86)]">What we do</p>
          <h2 className="mt-4 font-display text-5xl text-gold-metallic md:text-6xl">Services</h2>
