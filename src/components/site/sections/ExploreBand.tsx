...
export function ExploreBand() {
  return (
    <section id="explore" className="relative py-32">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[420px] w-[420px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[oklch(0.82_0.14_86)] opacity-[0.06] blur-[160px]" />
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-xs uppercase tracking-[0.5em] text-[oklch(0.82_0.14_86)]">Go deeper</p>
          <h2 className="mt-4 font-display text-5xl text-gold-metallic md:text-6xl">Explore</h2>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {cards.map((c) => (
            <TiltCard key={c.to} intensity={6}>
              <Link to={c.to} className="group flex h-full flex-col p-8">
                ...
                <h3 className="mt-6 font-display text-3xl text-foreground">{c.title}</h3>
